...
<html>
    ...
    <body>
        ...
        <svg width="500" height="400">
            <rect id="felt" x="0" y="0" width="500" height="400"/>
            <g>
            ...
            <circle id="puck" r="25" cx="250" cy="300"/>
            <text id="point" x="250" y="310">X</text>
            <text id="message" x="250" y="370">Roll To Play</text>
        </svg>
        <div id="control">
            Winnings: <span id="winnings"><b>$50</b></span>
